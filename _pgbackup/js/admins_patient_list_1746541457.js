...
createApp({
  ...
  return digits.length === 11 && digits.startsWith('7');
    ...
    function openEdit() {
        ...
        if (selectedPatient.value.birth_date) {
            const [day, month, year] = selectedPatient.value.birth_date.split('.');
            form.birth_date = `${day.padStart(2, '0')}-${month.padStart(2, '0')}-${year}`;
        }
